...
//     const changeCaseStatus ((status){
//         const history = await getReassignmentStatus(id, status);
//         if(history){
...
//                         <div className="flex gap-2">
//                             <Button className="w-full" onClick={changeCaseStatus("approve")}>
//                                 {isSubmitting ? <Loader2 className="animate-spin mr-2 h-4 w-4" /> : null}
//                                 APPROVE REQUEST
//                             </Button>
//                             <Button variant="outline" onClick={changeCaseStatus("deny")} className="w-full">
//                                 {isSubmitting ? <Loader2 className="animate-spin mr-2 h-4 w-4" /> : null}
//                                 DENY REQUEST
//                             </Button>
//                         </div>
