            ...
            <ScrollArea className="h-[600px] w-full p-4">
              <div className=" space-y-6">
                <div className="gap-2 border-b-[1px]  space-y-2 border-app-primary py-4">
                  <p className="text-xs font-bold text-stone-600">2025-01-06</p>
                  <div className="flex justify-start ">
                    <Icons.check />
                    <div className="text-sm">
                      <p className="font-bold">Reassignment approved</p>
                      <p className="font-semibold">Assigning Magistrate [Emily Clark] approved reassignment for this Case ID 34567 to Presiding Magistrate [Sarah Ahmed].</p>
                    </div>
                  </div>
                </div>
                <div className="flex justify-start gap-2  border-b-[1px]  border-app-primary py-4">
                  <Icons.Redcross className="size-8 h-6 w-6" />
                  <div className="text-sm">
                    <p className="font-bold">Reassignment denied</p>
                    <p className="font-semibold">Assigning Magistrate [Emily Clark] denied reassignment for this Case ID 34567 to Presiding Magistrate [Sarah Ahmed].</p>
                  </div>
                </div>
              </div>
