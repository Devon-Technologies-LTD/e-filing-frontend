  ...
  return (
    <div className="space-y-1">
      <div className="flex justify-between items-center">
        <p className="text-sm font-bold text-neutral-600">CIVIL FORM 8</p>
        <DownloadSampleButton
          fileName="sample_civil_form_8"
          imageSrc={"/downloadable-images/civil-form-8.png"}
        />
      </div>
