...
//       }
//     } else {
//       if (reassignmentStatus != "" && reassignmentStatus.toLowerCase() !== "under review") {
//         if (reassignmentStatus.toLowerCase() == "approved") {
//           badges.push(<StatusBadge key="reassignment" status="ASSIGNED" />);
//         } else if (reassignmentStatus.toLowerCase() !== "denied") {
//           badges.push(<StatusBadge key="reassignment" status="UNASSIGNED" />);
//         } else {
//           badges.push(<StatusBadge key="reassignment" status={reassignmentStatus} />);
//         }
//       } else if (caseRequestStatus && caseRequestStatus.toLowerCase() !== "under review") {
//         if (caseRequestStatus.toLowerCase() !== "approved") {
//           badges.push(<StatusBadge key="case-request" status="ASSIGNED" />);
//         } else if (caseRequestStatus.toLowerCase() !== "denied") {
//           badges.push(<StatusBadge key="case-request" status="UNASSIGNED" />);
//         } else {
//           badges.push(<StatusBadge key="case-request" status={caseRequestStatus} />);
//         }
//       } else {
//         if (data?.status.toLowerCase() !== "approved" && data?.status.toLowerCase() !== "under review" && data?.status.toLowerCase() !== "denied") {
//           badges.push(<StatusBadge key="status" status={data?.status} />);
//         }
//       }
//     }
