...
export default function CASEMETRIC({ metric }: CaseMetricProps) {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [selectedMetric, setSelectedMetric] = useState<Metric | null>(null);
    const [metrics] = useState<Metric[]>(metric); // Initialize metrics with the passed prop
    ...
    const labels = ["wuse zone 1", "wuse zone 2", "wuse zone 3", "wuse zone 4", "wuse zone 5", "wuse zone 1", "wuse zone 2", "wuse zone 3", "wuse zone 4", "wuse zone 5"];
    const data = [20, 35, 80, 20, 50, 80, 20, 50, 80, 20];
    ...
    const MetricCard: React.FC<{ metric: Metric; onClick: () => void }> = ({ metric, onClick }) => {
        return (
            <div className="space-y-6 bg-white shadow-lg rounded-lg">
                ...
                <div
                    className="py-2 p-4 text-sm text-black font-bold cursor-pointer"
                    onClick={onClick}
                >
                    View Breakpoint
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <div className="space-y-8">
                            <div>
                                <h2 className="text-xl font-semibold mb-4">{selectedMetric.title}</h2>
                            ...
                            <div className="flex justify-between">
                                <div>
                                    ...
                                    <span className="text-base text-app-primary">
